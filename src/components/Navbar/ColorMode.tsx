...
const ColorMode = () => {
  ...
  return (
    <div
      ...
      } before:-z-[1] before:absolute before:size-10.5 before:transition-all before:duration-700  before:bg-orange-500 before:rounded-full items-center gap-4 bg-neutral-100  p-[2px] rounded-full justify-between`}
    >
      <button
