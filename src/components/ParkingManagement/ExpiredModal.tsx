...
const ExpiredModal = () => {
  return (
    <div className=" w-[31.375rem] p-6 ">
      <StatusModalHeader type={STATUS_LABELS.EXPIRED} />
      ...
      <EstimatedTime guestName="a" roomNumber="a" theme="red" />
      <div className="flex items-center border-t  border-t-gray-350 dark:border-gray-800   pt-6 mt-2 gap-4 justify-end">
        <Button
